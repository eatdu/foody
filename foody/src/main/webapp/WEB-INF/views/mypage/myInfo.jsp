...
<div class="loginInfo">
	<div class="userInfo">
		<div class="profile">
			...
			<div class="modifyCon">
				<div class="wrap">
					<a href="#pop_info_1" class="userInfoModifyBtn" id="modifyBtn">회원정보수정</a>
					<a href="#pop_info_2" class="userInfoModifyBtn" id="exitBtn">탈퇴하기</a>
					<div id="pop_info_1" class="pop_wrap" style="display:none;">
						<div class="pop_inner">
							...
							<button type="button" class="btn_close" id="pop_info_1_close">닫기</button>
						</div>
					</div>
					<div id="pop_info_2" class="pop_wrap" style="display:none;">
						<div class="pop_inner">
							...
							<button type="button" class="submitBtn" id="userInfoModify" onclick="$('#exitPwdCheck').submit();">탈퇴하기</button>
							<button type="button" class="btn_close" id="pop_info_2_close">닫기</button>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	// 팝업 닫기
	$('#pop_info_1_close').click(function() {
		$("#pop_info_1").hide();
	});
	$('#pop_info_2_close').click(function() {
		$("#pop_info_2").hide();
	});
</script>