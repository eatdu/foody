...
<style>
	.signUp_title{font-size: 60px;}
	.sub_title{
		font-size: 40px;
		margin-left: 5%;
	} 
	#sub_title_line{
		border-bottom:thick solid #6A6D6F;
		border-width:unset;
		width:63%;
	}
	.signUp_th{font-size:30px;}
	table tr td{
		font-size: 22px;
	    color: #2e2e2e;
	    height: 39px;
	...
	#email,#nik_name,#name,#tel2,#tel3,#birth1,#birth2,#pwd,#pwd_check,#zipcode,#addr1,#addr2{height:35px;font-size: 20px;border-radius:7px;text-indent: 2px;}
	.signUpFrm{margin-left: 30px;} .signUp_board_write{width:79%;height: 200px;}
	.btnSet_clear{float:right;margin-right:630px;margin-top:5px;}  
	...
	#tel2,#tel3{border: 1px solid #cccccc;}
</style>
...
<%@ include file="../common/navBar.jsp" %>
	<div class="sub">
	    ...
	    <div class="size">
	        <h3 class="sub_title" id="sub_title_line">기본정보</h3>
	            ...
	            <tbody>
	                ...
	                <tr>
	                    ...
	                    <td>
	                    	...
	                    	<span class="telAdd">
		                    	<input type="number" class="" name="tel2" id="tel2" style="width:53px;" maxlength="4" required> -
		                    	<input type="number" class="" name="tel3" id="tel3" style="width:53px;" maxlength="4" required>
	                    	</span>
	           			</td>
	                </tr>
	                <tr>
	                    ...
	                    <td>
	                        ...
	                        <input type="text" name="birth1" id="birth1" class="" style="width:77px;" maxlength="6" required>-
	                        <input type="password" name="birth2" id="birth2" class="" style="width:18px;text-indent: -2px;"maxlength="1" required><span>******</span>
	           			</td>
	                </tr>
	                <tr>
	                    <th class="signUp_th">비밀번호</th>
	                    <td><input type="password" name="pwd" id="pwd" style="float:left;" required>
	                    <span style="font-size:20px;color:#6A6D6F;margin-top:10px;margin-left:4px;">비밀번호는 숫자, 영문 조합으로 8자 이상으로 입력해주세요.</span></td>
	                </tr>
	                <tr>
	                ...
	                <tr>
	                    ...
	                    <td>
	                        ...
	                        <span class="email_check"><a href="javascript:zipcode();"  class="btn bgGray" style="float:left; width:auto; clear:none;margin-left: 6px;">우편번호</a></span>
	                    </td>
	                </tr>
	                <tr>	
	                    <td>
